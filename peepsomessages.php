	...
	public function init()
	{
		...
		if (is_admin()) {
			...
			add_filter('peepso_admin_config_tabs', function($tabs){
                $tabs['messages'] = array(
                    'label' => __('Chat', 'msgso'),
                    'icon' => 'data:image/svg+xml;base64,',
                    'tab' => 'messages',
